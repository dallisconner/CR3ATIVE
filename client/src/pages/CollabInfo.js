        ...
        <div className="CollabInfo">
            <Container className="mt-4">
                ...
                <Container className="mt-12">
                    <Col size="6">
                        <p>Description of Collaboration</p>
                    </Col>
                </Container>
